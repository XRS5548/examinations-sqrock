    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-zinc-900 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white dark:bg-zinc-950 rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-3">Exam Not Available</h1>
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-zinc-900 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white dark:bg-zinc-950 rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-3">Exam Already Completed</h1>
          <p className="text-gray-600 dark:text-zinc-400 mb-6">
